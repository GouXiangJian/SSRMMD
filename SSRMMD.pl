...
Function:
  Mining SSR feature loci and candidate polymorphic SSR.
...
Example:
  1. Mining SSR feature loci :
       perl SSRMMD.pl -f1 example.fa -t 2

  2. Mining polymorphic SSR  :
       perl SSRMMD.pl -f1 example1.fa -f2 example2.fa -p 1 -t 2 -me LD
###############################################################################
...
die "Error: option '-ss' just be set to 0 or 1 !\n" if $stat_file != 0 and $stat_file != 1;
