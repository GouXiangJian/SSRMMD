...
sub generate_all_SSRs_stat_file{
	...
	open my $OUT,'>',$out_file_name or die "can't generate $out_file_name:$!";
...
sub final_comparison_table{
	...
	open my $OUT,'>',$out_file_name or die "can't generate $out_file_name:$!";
	print $OUT "genome1_id\tgenome1_motif\tgenome1_repeat_num\tgenome1_start\tgenome1_end\tgenome2_id\tgenome2_motif\tgenome2_repeat_num\tgenome2_start\tgenome2_end\tleft_fs\tleft_fs_len\tright_fs\tright_fs_len\tpolymorphism\n";
